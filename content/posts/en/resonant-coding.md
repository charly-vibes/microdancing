...
[^context]: Horthly's Context Engineering document is [publicly available](https://github.com/humanlayer/advanced-context-engineering-for-coding-agents/blob/main/ace-fca.md) and is probably the best introduction to the topic that exists. Warning: it's technical, detailed, and once you start reading it's hard to stop.
...
[^vibe]: The term "Vibe Coding" was coined by Andrej Karpathy in a tweet, but the concept was developed in depth in the book [*Vibe Coding*](https://www.amazon.com/Vibe-Coding-Software-Development-LLM-Assisted/dp/B0DPCS76G9) by Steve Yegge and Gene Kim (2024). The book is excellent and worth reading, although my methodology goes in a slightly different direction.
