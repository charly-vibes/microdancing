...
[^ubiquitous]: "Ubiquitous" is one of those words that sounds like corporate jargon but has no good replacement. It means "present everywhere at the same time." Like air, or anxiety, or soon language models.

[^callcenter]: There's something profoundly ironic in the fact that call centers—those places that for decades were synonymous with alienating work, robotic scripts read by exhausted humans, and infinite waits with elevator music—are being replaced by robots that, in many cases, do the job better. I don't know if this is progress or simply a change in who suffers. Probably both.

[^banks]: The banking experience for older people is a case study in how not to design technology. Systems thought up by young people for young people, deployed in contexts where the majority of users are over sixty, with fingers that no longer respond like they used to, and a relationship with technology that oscillates between distrust and terror. Every ATM with a confusing interface, every app that requires twelve steps to see your balance, every employee who responds "you have to do it through the app" is a small systemic cruelty.

[^cost]: The human cost of automation is a topic that deserves more space than I can give it here. There are entire books about this. My personal position, for what it's worth, is that technology itself is neither good nor bad—it's a tool—but the decisions about how it's implemented and who benefits are deeply political. Pretending they're purely technical is a form of evading responsibility.

[^tokens]: To give a concrete idea: at the time of writing, using GPT-4 costs approximately $30 per million input tokens and $60 per million output tokens. A token is approximately three-quarters of a word in English. An intensive work session can easily consume several million tokens. Claude, the model used by the tool I wrote much of this text with, has similar prices. Anthropic offers monthly plans with usage limits; when you hit the limit, you either pay more or wait until next month. It's a new economy with new rules, and most people are navigating it blind.

    But there's something more, something that borders on addiction and that I don't know if it has a name yet. All the time I find myself asking things of the models because it *seems* like they give results: explain how the concept of form in Simondon relates to Gombrowicz, how to know if I'm addicted to AI, how to stop working while living in the southern hemisphere, how to be calmer and avoid the stress of "going faster," what plants to plant in the garden that are native and good for learning permaculture, how to get clients, how to change jobs to one where I can apply what I know without it being yet again to enrich those who already have the money, where to learn about crypto, what physical activity to do if I don't like exercise or feeling tired, how to learn to write, how to make a LinkedIn post, how to quit, how to spend less on tokens, how to know if I'm depressed, how to understand the country's inheritance laws, how to understand a one-year-old baby, how to replicate my voice, how to translate a book, what the copyright law says, where my last name comes from, how to build a SaaS, how to work less, what's the optimal width for a shower, how to stop thinking. And so on, question after question, token after token, like someone smoking one more cigarette thinking it'll be the last.

[^skills]: This is the question that unsettles me most. There are skills that develop only through repeated practice: the ability to read other people's code, to detect problematic patterns, to anticipate how something will fail before it fails. If we delegate that practice to the model, what happens to our ability to do it ourselves? Do we become more efficient or simply more dependent? I don't have an answer, but I suspect the correct answer involves using the tools without ceasing to exercise the muscles that the tools could atrophy.
